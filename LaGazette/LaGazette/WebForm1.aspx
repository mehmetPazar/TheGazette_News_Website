    ...
    <section class="welcome-blog-post-slide owl-carousel">
        ...
        <div class="single-blog-post-slide bg-img background-overlay-5" >
            ...
            <div class="single-blog-post-content">                             
                ...
                <h3><a href="WebForm3.aspx?title=<%# Eval("Title") %>" class="font-pt"><%# Eval("Title") %> </a></h3>
                <div class="date">
                ...
                <ul class="marquee-content-items">
                    <li>
                        <asp:Repeater ID="Repeater2" runat="server">
                            <ItemTemplate> 
                                <a href="WebForm3.aspx?title=<%# Eval("Title") %>"><span class="latest-news-time"><%# Eval("Category") %></span> <%# Eval("Title") %>  </a>
                            </ItemTemplate>
                        </asp:Repeater>
                    </li>
                </ul>
                    ...
                    <div class="gazette-welcome-post">
                        ...
                        <div class="post-continue-reading-share d-sm-flex align-items-center justify-content-between mt-30">
                            <div class="post-continue-btn">
                                <a href="WebForm3.aspx?title=<%# Eval("Title") %>" class="font-pt">Okumaya Devam Et <i class="fa fa-chevron-right" aria-hidden="true"></i></a>
                            </div>
                    ...
                    <div class="gazette-todays-post section_padding_100_50">
                        ...
                        <div class="gazette-single-todays-post d-md-flex align-items-start mb-50">
                            ...
                            <div class="todays-post-content">
                                ...
                                <h3><a href="WebForm3.aspx?title=<%# Eval("Title") %>" class="font-pt mb-2"><%# Eval("Title") %></a></h3>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-7">
                                    <div class="editorial-post-content">
                                        ...
                                        <h2><a href="WebForm3.aspx?title=<%# Eval("Title") %>" class="font-pt mb-15"><%# Eval("Title") %></a></h2>
